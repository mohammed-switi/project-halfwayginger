...
public class AuthenticationControllerTest {
    ...
    public void init(){
       registerOrganizationRequest = RegisterRequest.builder()
                ...
                .education("")
                .badge("")
                .position(null) // Set default value for Position or remove this line if it's not nullable
                .build();
    ...
    public void AuthenticationController_CreateOrginizationalUser_ReturnAuthenticationResponse() throws Exception{
        ...
        response.andExpect(MockMvcResultMatchers.status().isCreated())
                .andExpect(MockMvcResultMatchers.jsonPath("$.firstName", CoreMatchers.is(registerOrganizationRequest.getFirstName())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.email", CoreMatchers.is(registerOrganizationRequest.getEmail())))
    ...
    public void AuthenticationController_CreateAcademicUser_ReturnAuthenticationResponse() throws Exception{
        ...
        response.andExpect(MockMvcResultMatchers.status().isCreated())
                .andExpect(MockMvcResultMatchers.jsonPath("$.firstName", CoreMatchers.is(registerAcademicRequest.getFirstName())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.email", CoreMatchers.is(registerAcademicRequest.getEmail())))
    ...
    public void AuthenticationController_LoginRequest_ReturnAuthenticationResponse() throws Exception {
        ...
        AuthenticationResponse authenticationResponse = new AuthenticationResponse("Dummy Jwt Token", "Dummy ConfirmationToken");
        ...
        response.andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.jwtToken", CoreMatchers.is(authenticationResponse.getJwtToken())))
                .andExpect(MockMvcResultMatchers.jsonPath("$.confirmationToken", CoreMatchers.is(authenticationResponse.getConfirmationToken())))
