...
public class OrganizationControllerTest {
        ...
        public void OrganizationController_GET_AllOrganizations_ReturnAllOrganizations() throws Exception {
                ...
                when(organizationService.findAllOrganizations()).thenReturn(
        ...
        @Test
        public void OrganizationController_PATCH_AddAcademicToOrganization_ReturnAddedToOrganizations()
                        throws Exception {
        ...
        public void OrganizationController_DELETE_DeleteAcademicFromOrganization_ReturnNoContent() throws Exception {
                ...
                doNothing().when(organizationService).removeAcademic(1L,
