    ...
    return args -> {
      ...
      for (Name name : names) {
        academics.add(new Academic(name.toString(), name.getFirstName(),
            "pass1234" + name.getFirstName(), name.getLastName() + name.getFirstName() + "@bethlehem.edu"));
      ...
      for (int i = 0; i < bound; i++) {
        Academic academic = academics.get(random.nextInt(academics.size()));
        organizations.add(new Organization("name" + academic.getName(), "username" + academic.getName(),
