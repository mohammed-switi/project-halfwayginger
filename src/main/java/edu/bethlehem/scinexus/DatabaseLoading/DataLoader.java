...
//                dataGenerator.generateMaxLorem(100), dataGenerator.generateRandomFieldOfWork(), user);
//        article.setInteractionsCount(0);
//        article.setOpinionsCount(0);
//        article.setVisibility(dataGenerator.generateRandomVisibility());
//        article.setBrief(dataGenerator.generateMaxLorem(20));
//
...
//            Media media = new Media("svg", "autogenerated");
...
//        for (User user : users) {
//            for (int i = 0; i < 2; i++) {
//                Article article = new Article(dataGenerator.getRandomTitle(),
//                        dataGenerator.generateMaxLorem(100), dataGenerator.generateRandomFieldOfWork(), user);
//                article.setInteractionsCount(0);
//                article.setOpinionsCount(0);
//                article.setVisibility(dataGenerator.generateRandomVisibility());
//                article.setViewsCount(random.nextInt(100000));
//                article.setBrief(dataGenerator.generateMaxLorem(20));
//                article.setKeyPhrases(dataGenerator.getRandomKeyPhrase());
//                user.addJournal(article);
...
//                researchPaper.setDescription(dataGenerator.generateMaxLorem(1));
...
//                Opinion opinion = new Opinion(dataGenerator.generateMaxLorem(2), journal,
...
//            notification.setContent("This Notification was sent to you by the system");
